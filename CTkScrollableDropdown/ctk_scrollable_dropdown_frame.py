...
class CTkScrollableDropdownFrame(customtkinter.CTkFrame):
    ...
    def place_dropdown(self):
        self.x_pos = self.attach.winfo_x() if self.x is None else self.x
        self.y_pos = self.attach.winfo_y() + self.attach.winfo_reqheight() + 5 if self.y is None else self.y
